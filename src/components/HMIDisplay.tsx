    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
      <div className="bg-white rounded-xl shadow-lg p-8">
        <div className="mb-6 flex items-center">
          <div className="bg-gradient-to-r from-zseetech-green to-zseetech-green-light p-3 rounded-lg mr-4">
            {icon}
          </div>
          <h3 className="text-2xl font-semibold text-zseetech-blue-dark">{title}</h3>
        </div>
        ...
        <ul className="space-y-3 mb-8">
          {features.map((feature, index) => (
            <li key={index} className="flex items-start">
              <div className="mt-1 w-2 h-2 rounded-full bg-zseetech-green mr-2"></div>
              <span className="text-gray-700">{feature}</span>
            </li>
          ))}
        </ul>
        
        <Button className="w-full md:w-auto bg-gradient-to-r from-zseetech-green-light to-zseetech-green text-white">
      ...
      <div className={`relative rounded-xl overflow-hidden shadow-lg h-[400px] ${imageClass}`}>
        <div className="absolute inset-0 bg-black/30 flex items-center justify-center">
          <div className="bg-white/90 backdrop-blur-sm p-6 rounded-lg max-w-xs text-center">
            <h4 className="font-semibold text-zseetech-blue-dark mb-2">{title} Sample UI</h4>
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <div className="flex justify-center mb-4">
            <div className="bg-gradient-to-r from-zseetech-green-light to-zseetech-green p-4 rounded-full">
              <Monitor className="w-12 h-12 text-white" />
            </div>
          </div>
          <h2 className="text-3xl md:text-4xl font-bold text-zseetech-blue-dark mb-4">Custom HMI Solutions</h2>
        ...
        <Tabs defaultValue="industrial" className="w-full">
          <TabsList className="grid grid-cols-2 md:grid-cols-4 gap-2 bg-transparent mb-8">
            <TabsTrigger 
              value="industrial"
              className="data-[state=active]:bg-zseetech-green data-[state=active]:text-white"
            >
        ...
        <div className="mt-16 text-center">
          <h3 className="text-2xl font-semibold text-zseetech-blue-dark mb-6">Cross-Platform Capabilities</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div className="bg-white p-6 rounded-lg shadow-md">
              <div className="bg-zseetech-green/10 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <Monitor className="w-8 h-8 text-zseetech-green" />
              </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <div className="bg-zseetech-green/10 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <Fan className="w-8 h-8 text-zseetech-green" />
              </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <div className="bg-zseetech-green/10 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <Gauge className="w-8 h-8 text-zseetech-green" />
              </div>
        ...
        <div className="mt-16 text-center">
          <Button size="lg" className="bg-zseetech-green hover:bg-zseetech-green-dark">
